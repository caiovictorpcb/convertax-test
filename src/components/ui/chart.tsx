          ...
          {payload.map((item, index) => {
            ...
            return (
              <div
                key={item.dataKey}
                className={cn(
                  "flex w-full items-stretch gap-2 [&>svg]:size-2.5 [&>svg]:text-slate-500 dark:[&>svg]:text-slate-400",
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div
                      className={cn(
                        "flex flex-1 flex-row justify-between gap-2 leading-none",
        ...
        {payload.map((item) => {
          ...
          return (
            <div
              key={item.value}
              className={cn(
                "flex items-center gap-1.5 [&>svg]:size-3 [&>svg]:text-slate-500 dark:[&>svg]:text-slate-400",
              )}
            >
